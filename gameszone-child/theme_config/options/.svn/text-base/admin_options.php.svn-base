                ...
                array(
                    ...
                    'options' => array(/* 1 */
                        ...
                        //PinchPoint added
	                    	...
	                    	array(
	                    				'name' => __('Google Play Store IMG','tfuse'),
	                    				'desc' => __('Upload a "GOOGLE PLAY STORE IMG" for your GAMES, or specify the image address of your online logo. (//yoursite.com/logo.png)','tfuse'),
	                    				'id' => TF_THEME_PREFIX . '_google_play_img',
	                    				'value' => '',
	                    				'type' => 'upload'
	                    	),
                    		array(
                    				'name' => __('iOS App Store IMG','tfuse'),
                    				'desc' => __('Upload an "iOS app store IMG" for your GAMES, or specify the image address of your online logo. (//yoursite.com/logo.png)','tfuse'),
                    				'id' => TF_THEME_PREFIX . '_ios_appstore_img',
                    				'value' => '',
                    				'type' => 'upload'
                    		),
                    		
                    		array(
                    				'name' => __('facebook game page IMG','tfuse'),
                    				'desc' => __('Upload a "facebook game page IMG" for your GAMES, or specify the image address of your online logo. (//yoursite.com/logo.png)','tfuse'),
                    				'id' => TF_THEME_PREFIX . '_facebook_page_img',
                    				'value' => '',
                    				'type' => 'upload'
                    		),
