...
$options = array(
    ...
    array('name' => __('Developed by Link','tfuse'),
	 ...
	 array('name' => __('Android','tfuse'),
        'desc' => __('Android','tfuse'),
        'id' => TF_THEME_PREFIX . '_android_link',
        'value' => '',
        'type' => 'text',
        'divider' => true
    ),
	array('name' => __('iOS','tfuse'),
        'desc' => __('iOS','tfuse'),
        'id' => TF_THEME_PREFIX . '_ios_link',
        'value' => '',
        'type' => 'text',
        'divider' => true
    ),
	array('name' => __('facebook','tfuse'),
			'desc' => __('facebook','tfuse'),
			'id' => TF_THEME_PREFIX . '_facebook_link',
			'value' => '',
			'type' => 'text',
			'divider' => true
	),
	array('name' => __('Press Email','tfuse'),
			'desc' => __('PressEmail','tfuse'),
			'id' => TF_THEME_PREFIX . '_press_email',
			'value' => '',
			'type' => 'text',
			'divider' => true
	),
		
		array('name' => __('Facebook Social Community','tfuse'),
				'desc' => __('FaceBook Social','tfuse'),
				'id' => TF_THEME_PREFIX . '_facebook_social',
				'value' => '',
				'type' => 'text',
				'divider' => true
		),
		
		array('name' => __('Twitter Social Community','tfuse'),
				'desc' => __('Twitter Social','tfuse'),
				'id' => TF_THEME_PREFIX . '_twitter_social',
				'value' => '',
				'type' => 'text',
				'divider' => true
		),
