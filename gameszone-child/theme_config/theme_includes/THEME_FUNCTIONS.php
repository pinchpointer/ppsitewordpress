...
if (!function_exists('tfuse_type_logo')) :
    function tfuse_type_logo() { 
        ...
        if($logo_type == 'img')
        {
            ...
            {  ?> 
                  <h1 class="site-title">
					<a href="<?php echo home_url(); ?>"><img src="<?php echo tfuse_options('logo'); ?>"  border="0" />
	  ...
	  <?php }
        ...
        { ?>
            <h1 class="site-title"><a href="<?php echo home_url(); ?>"><span><?php echo tfuse_options('logo_text','PinchPoint'); ?></a></span></h1>
      <?php  }
    }
endif;
