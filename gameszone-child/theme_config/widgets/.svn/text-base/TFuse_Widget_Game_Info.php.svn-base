...
class TFuse_Widget_Game_Info extends WP_Widget {
	...
	function TFuse_Widget_Game_Info() {
            ...
            $this->__construct('game_info', __('TFuse Game Info','tfuse'), $widget_ops);
	}
            ...
            <?php if($post->post_type == 'game' || $post->post_type == 'review'):?>
                <?php 
                    ...
                    if(!empty($id)):
                        ...
                        $press_contact = tfuse_page_options('press_email','',$id);
                        $facebook_social = tfuse_page_options('facebook_social','',$id);
                        $twitter_social = tfuse_page_options('twitter_social','',$id);
                        ...
                        <div class="widget widget_text widget-boxed">
                            ...
                            <div class="textwidget">
                                <div class="game-infobox">
                                    ...
                                    <?php if(!empty($press_contact)):?>
                                        <h4><?php echo  __('Press contact','tfuse') ; ?></h4>
                                      <?php echo '<a href="mailto:'.$press_contact.'">'.$press_contact.'</a>';?>
                                        <br>
                                    <?php endif;?>
                                    
                                    <br>
                                    <?php if(!empty($facebook_social) || !empty($twitter_social)):?>
                                        <h4><?php echo  __('Social','tfuse') ; ?></h4>
                                         <div style="text-align:left" class="footer-socials">
                                         	<span class="social-icons social-icons-games">
    
                                        <?php if(!(empty($facebook_social))):?>
        									<a href="<?php echo $facebook_social?>" target="_blank" title="'.__('Facebook','tfuse').'"><i class="tficon-facebook"></i> <span>'.__('Facebook','tfuse').'</span></a>
                                        <?php endif;?>
                                        
                                        <?php if(!(empty($twitter_social))):?>
          									<a href="<?php echo $facebook_social?>" target="_blank" title="'.__('Twitter','tfuse').'"><i class="tficon-twitter"></i> <span>'.__('Twitter','tfuse').'</span></a>
