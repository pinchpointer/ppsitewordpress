...
jQuery(document).ready(function($) {
    ...
    $('#save_changes_slide').on('click',function(){
        slide_settings={};
        for(var prop in tf_script.slide_ids) {
    ...
    $('#cancel_changes_slide').on('click',function(){
    ...
    $('.remove_frame').on('click',function(){
    ...
    $('.tf_delete_slider').on('click',function(){
