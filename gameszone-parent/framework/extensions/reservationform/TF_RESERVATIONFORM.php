    ...
    function add_menu()
    {
        if (function_exists( 'add_object_page' )) {
            add_object_page(
                ...
                apply_filters( 'res_form_top_menu', __( 'Reservations', 'tfuse' ) ),
                'publish_pages',
            ...
            foreach ($headings as $heading) {
                ...
                if ($id !== false) {
                    ...
                    if ($heading['id'] == 'form_settings') {
                        ...
                        $admin_meta_boxes[$tab['id']][$heading['name']] .= $this->optigen->$add_button['type'](
                            $add_button
                        );
                        $admin_meta_boxes[$tab['id']][$heading['name']] .= $this->optigen->$prev_button['type'](
                            $prev_button
                        );
