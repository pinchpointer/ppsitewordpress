...
jQuery(document).ready(function ($) {  sortStop();
    ...
    $(".ui-selectmenu-status").on('mouseover', function (event) {
        offset = $(this).offset();
    ...
    $(".sortable_options .tfuse-tax-form-field ").on({
        mouseover:function () {
    ...
    $(".tf_custom_reservationform_row ").on({
        mouseover:function () {
    ...
    $('.'+theme_index+'_inp_select').on("change", function () {
    ...
    $('.cf_add_option').on('click', function () {
    ...
    $('#TB_ajaxContent #reservationForm').on('submit', function () {
        return false;
    });
    ...
    $(".reservationform_delete_input").on("click", function () {
    ...
    $('.tf_cf_delete_option').on('click', function () {
        _li = $(this).closest('li');
  ...
  $('.excludedate_ok').on('click', function (event) {
    ...
    $('.tf_exclude_from_datepicker').on('click', function () {
        date_orientation = 'from';
    });
    $('.tf_exclude_to_datepicker').on('click', function () {
        date_orientation = 'to';
    });
    $('.reservationform_delete_excludedatesinput').on('click', function () {
    ...
    $('.tf_custom_reservationform_dates_row').on({
        mouseover:function () {
    ...
    $('.rf_input_width').on('keyup', function () {
        if ($(this).val() < 0) {
            $(this).val(0);
