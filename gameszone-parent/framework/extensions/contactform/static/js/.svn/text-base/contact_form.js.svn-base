...
jQuery(document).ready(function ($) {
    ...
    $('.medica_inp_select').on('change', function () {
    ...
    $('#TB_ajaxContent #contactForm').on('submit', function () {
        return false;
    });
    ...
    $('.contactform_delete_input').on('click', function () {
    ...
    $('.cf_input_width').on('keyup', function () {
        if ($(this).val() < 0) {
            $(this).val(0);
